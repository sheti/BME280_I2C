...
#define BME280_I2C_ADDR 0x76 //0x76 default I2C address
...
class BME280_I2C {
	public: 
		...
		BME280_I2C();
        BME280_I2C(uint8_t i2caddr);
		bool init();
		uint32_t getPressure(bool isTempExist = false);
		int32_t getTemperature(void);
        uint32_t getHumidity(bool isTempExist = false);
		int32_t temperature;
		void setSampling(
